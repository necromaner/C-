...
//
//static inline void INIT_LIST_HEAD(struct list_head *list){//初始化链表
//    list->next = list;
//    list->prev = list;
//}
//
...
//                              struct list_head *next){//在prev后next前插入
//    next->prev = list_new;
//    list_new->next = next;
//    list_new->prev = prev;
//    prev->next = list_new;
//}
//#else
//extern void __list_add(struct list_head *list_new,
//			      struct list_head *prev,
...
// */
//static inline void list_add_tail(struct list_head *list_new, struct list_head *head){//list后插入
