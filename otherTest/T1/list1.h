...
//	struct priority_list1 name = LIST_HEAD_INIT(name)
//
///**
...
//extern bool __list_add_valid(struct list_head *list_new,
//			      struct list_head *prev,
//			      struct list_head *next);
//extern bool __list_del_entry_valid(struct list_head *entry);
//#else
//static inline bool __list_add_valid(struct list_head *list_new,
//                                    struct list_head *prev,
//                                    struct list_head *next)
//{
//    return true;
...
//                              struct list_head *next)
//{
//    if (!__list_add_valid(list_new, prev, next))
//        return;
//
//    next->prev = list_new;
//    list_new->next = next;
//    list_new->prev = prev;
//    WRITE_ONCE(prev->next, list_new);
//}
//
///**
...
//{
//    struct list_head *list_new_first = entry->next;
//    list->next = head->next;
//    list->next->prev = list;
//    list->prev = entry;
//    entry->next = list;
...
//	struct priority_list1 *head__ = (ptr); \
//	struct priority_list1 *pos__ = READ_ONCE(head__->next); \
...
//
///**
// * hlist_add_behing - add a list_new entry after the one specified
// * @n: list_new entry to be added
